...
This mechanism has been integrated into Bitcore-Node-Blocknode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Blocknode-Project/insight-api-blocknode#web-socket-api](https://github.com/Blocknode-Project/insight-api-blocknode#web-socket-api) 
* API: [https://github.com/Blocknode-Project/insight-api-blocknode#swifttx-transactions](https://github.com/Blocknode-Project/insight-api-blocknode#swifttx-transactions) 
...
By default, the Blocknode Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Blocknode Core daemon:
