...
In order to support loading of multiple wallets in blocknode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blocknode.cpp.
...
Changes to blocknode.cpp
----------------------
blocknode.cpp is the entry point into blocknode-qt, and as such, will require some minor modifications to provide hooks for
