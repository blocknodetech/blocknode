Contributing to Blocknode Core
============================

The Blocknode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Blocknode Core project, and is not to be
confused with overall Blocknode Network Protocol consensus changes.

Whether a pull request is merged into Blocknode Core rests with the project merge
...
Patches that change Blocknode consensus rules are considerably more involved than
...
Where a patch set proposes to change the Blocknode consensus, it must have been
...
The project leader is the release manager for each Blocknode Core release.
