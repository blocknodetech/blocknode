...
/** Utility functions used by the Blocknode Qt UI.
 */
namespace GUIUtil
{
...
// Render Blocknode addresses in monospace font
...
// Parse "blocknode:" URI into recipient object, return true on successful parsing
