...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Blocknode Core");
    ...
    QString copyrightTextBlocknode = QChar(0xA9) + QString(" 2018 ") + QString(tr("The Blocknode Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextBlocknode);
