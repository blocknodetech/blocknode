 ...
 */
    ...
    typeWidget->addItem(tr("Received Bnd from zBnd"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBnd"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBnd));
