...
#   c) node1 mines 32 blocks, so now node 0 has 60001bnd, node 1 has 4250bnd, node2 has none.
#   d) node0 sends 601 bnd to node2, in two transactions (301 bnd, then 300 bnd).
